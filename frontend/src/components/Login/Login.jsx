        ...
        <div className="flex flex-wrap items-center justify-center p-6">
          <div className="bg-white w-[850px] h-[450px] flex flex-row p-6 m-4 rounded-[15px] shadow-lg">
            ...
            <div className="flex-grow ml-2">
              ...
              <form className="flex flex-col text-left items-center justify-center" onSubmit={handleLogin}>
                <input className="mt-4  flex-none bg-gray-100 rounded-lg p-3 border-gray-300 border-[1.5px]  w-[320px]" type='email'  placeholder='Email or Phone' value={email} onChange={(e) => setEmail(e.target.value)}/>
                <div >
                  <input className="mt-8 flex-none  bg-gray-100 rounded-lg p-3  border-gray-300 border-[1.5px] w-[320px]" type='password' placeholder='Password' value={password} onChange={(e) => setPassword(e.target.value)}></input>
                  <div className="flex">
              ...
              <div className="text-black mt-2 flex items-center justify-center">
                <button className=" rounded-[20px] text-[16px] bg-zinc-200 h-[40px]  w-[320px] mt-4 p-2 hover:bg-[#dedede] hover:cursor-pointer text-black" onClick={handleGoogleLogin}>
                  <div className="flex">
